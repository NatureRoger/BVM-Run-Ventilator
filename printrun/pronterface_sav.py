...
def DB_Get_speed_Fvalue(db, x1, x2, total_x, t, debug_mod=0):
    ...
    if (debug_mod>0) : print ('    Fvalue=%s' % Fvalue)
    coefficient_adj = 1+ ((50000+Fvalue)/500000)/3.8
...
class PronterWindow(MainWindow, pronsole.pronsole):
    ...
    def create_menu(self):
        ...
        self.Bind(wx.EVT_MENU, lambda *e: PronterOptions(self), m.Append(-1, _("&Options呼吸設定"), _(" Options dialog")))
...
Printrun or BVM-Run<Ventilator>. If not, see <http://www.gnu.org/licenses/>."""
    ...
    def _add_settings(self, size):
        ...
        self.settings._add(ComboSetting("BVM_Ball_No", "2", ["1", "2", "3"], _("Choice the supported BVM_Ball"), _("Choice the supported BVM_Ball"), "UI"), self.reload_ui)
        ...
        self.settings._add(SpinSetting("BVM_RUN_Max_StokeX", 221, 100, 800, _("BVM_RUN 900mL Stoke X (Max Stoke)"), _("BVM_RUN 900mL Stoke X (Max Stoke)"), "External"))
    ...
    def Creat_Gcode(self, event):
        ...
        message = _("echo : InHale Volumn %dmL, Stoke X %d, 900mL Stoke X %d") % (V_mL, self.Stoke_X, self.settings.BVM_RUN_Max_StokeX)
        self.log(message)
        self.statusbar.SetStatusText(message)

        self.OneBreath_time = 60 / self.settings.Breaths_p_min
        ...
        message = _("echo : Breaths_p_min %d, OneBreath_time %fs, InHale_time %fs, ExHale_time %fs") % (self.settings.Breaths_p_min, self.OneBreath_time, self.InHale_time, self.ExHale_time)
        self.log(message)
        self.statusbar.SetStatusText(message)
        ...
        self.InHale0_F = DB_Get_speed_Fvalue(db, 0, self.InHale0_X, self.settings.BVM_RUN_Max_StokeX, self.InHale0_time, debug_mod=0) 

        message = _("echo : G91 G0 X%d F%d") % (self.InHale0_X, self.InHale0_F)
        self.log(message)
        self.statusbar.SetStatusText(message) 
        ...
        self.InHale1_F = DB_Get_speed_Fvalue(db, 0, self.InHale1_X, self.settings.BVM_RUN_Max_StokeX, self.InHale1_time, debug_mod=0) 

        message = _("echo : G0 X%d F%d") % (self.InHale1_X, self.InHale1_F)
        self.log(message)
        self.statusbar.SetStatusText(message)
        ...
        self.InHale2_F = DB_Get_speed_Fvalue(db, 0, self.InHale2_X, self.settings.BVM_RUN_Max_StokeX, self.InHale2_time, debug_mod=0) 

        message = _("echo : G0 X%d F%d") % (self.InHale2_X, self.InHale2_F)
        self.log(message)
        self.statusbar.SetStatusText(message)

        # In-Hale 3 HoldPressure
        ...
        self.InHale3_F = DB_Get_speed_Fvalue(db, 0, self.InHale3_X, self.settings.BVM_RUN_Max_StokeX, self.InHale3_time, debug_mod=0) 

        message = _("echo : G0 X%d F%d") % (self.InHale3_X, self.InHale3_F)
        self.log(message)
        self.statusbar.SetStatusText(message)
        ...
        self.InHale4_F = DB_Get_speed_Fvalue(db, 0, self.InHale4_X, self.settings.BVM_RUN_Max_StokeX, self.InHale4_time, debug_mod=0) 

        message = _("echo : G0 X%d F%d") % (self.InHale4_X, self.InHale4_F)
        self.log(message)
        self.statusbar.SetStatusText(message)
        ...
        self.InHale5_F = DB_Get_speed_Fvalue(db, 0, self.InHale5_X, self.settings.BVM_RUN_Max_StokeX, self.InHale5_time, debug_mod=0) 

        message = _("echo : G0 X%d F%d") % (self.InHale5_X, self.InHale5_F)
        self.log(message)
        self.statusbar.SetStatusText(message)   
        ...
        self.ExHale0_F = DB_Get_speed_Fvalue(db, 0, self.ExHale0_X, self.settings.BVM_RUN_Max_StokeX, self.ExHale0_time, debug_mod=0) 

        message = _("echo : G0 X-%d F%d") % (self.ExHale0_X, self.ExHale0_F)
        self.log(message)
        self.statusbar.SetStatusText(message) 
        ...
        self.ExHale1_F = DB_Get_speed_Fvalue(db, 0, self.ExHale1_X, self.settings.BVM_RUN_Max_StokeX, self.ExHale1_time, debug_mod=0) 

        message = _("echo : G0 X-%d F%d") % (self.ExHale1_X, self.ExHale1_F)
        self.log(message)
        self.statusbar.SetStatusText(message)  
        ...
        self.ExHale2_F = DB_Get_speed_Fvalue(db, 0, self.ExHale2_X, self.settings.BVM_RUN_Max_StokeX, self.ExHale2_time, debug_mod=0) 

        message = _("echo : G0 X-%d F%d") % (self.ExHale2_X, self.ExHale2_F)
        self.log(message)
        self.statusbar.SetStatusText(message)  
        ...
        self.ExHale3_F = DB_Get_speed_Fvalue(db, 0, self.ExHale3_X, self.settings.BVM_RUN_Max_StokeX, self.ExHale3_time, debug_mod=0) 

        message = _("echo : G0 X-%d F%d") % (self.ExHale3_X, self.ExHale3_F)
        self.log(message)
        self.statusbar.SetStatusText(message)  
        ...
        self.ExHale4_F = DB_Get_speed_Fvalue(db, 0, self.ExHale4_X, self.settings.BVM_RUN_Max_StokeX, self.ExHale4_time, debug_mod=0) 

        message = _("echo : G0 X-%d F%d") % (self.ExHale4_X, self.ExHale4_F)
        self.log(message)
        self.statusbar.SetStatusText(message) 
        ...
        self.ExHale5_F = DB_Get_speed_Fvalue(db, 0, self.ExHale5_X, self.settings.BVM_RUN_Max_StokeX, self.ExHale5_time, debug_mod=0) 

        message = _("echo : G0 X-%d F%d") % (self.ExHale5_X, self.ExHale5_F)
        self.log(message)
        self.statusbar.SetStatusText(message)         


        """
        DB_Get_speed_Fvalue(db, 0, 5, total_x, t, debug_mod=0) 
